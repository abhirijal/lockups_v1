 ...
 */
final class Version20220304183159 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE lockup_templates DROP org_first_line, DROP org_second_line, DROP subject_first_line, DROP subject_second_line, DROP acronym_first_line, DROP acronym_second_line, DROP acronym_subject, DROP extension');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE lockup_templates ADD org_first_line INT DEFAULT NULL, ADD org_second_line INT DEFAULT NULL, ADD subject_first_line INT DEFAULT NULL, ADD subject_second_line INT DEFAULT NULL, ADD acronym_first_line INT DEFAULT NULL, ADD acronym_second_line INT DEFAULT NULL, ADD acronym_subject INT DEFAULT NULL, ADD extension INT DEFAULT NULL, CHANGE name name VARCHAR(100) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE style style VARCHAR(20) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE image image VARCHAR(255) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE svg svg LONGTEXT DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE description description LONGTEXT DEFAULT NULL COLLATE `utf8mb4_unicode_ci`');
