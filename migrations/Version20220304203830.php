 ...
 */
final class Version20220304203830 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE lockup_templates_fields_map (id INT AUTO_INCREMENT NOT NULL, lockup_template_id INT DEFAULT NULL, lockup_fields_id INT DEFAULT NULL, INDEX IDX_3BC2632751871A21 (lockup_template_id), INDEX IDX_3BC26327BD6108B9 (lockup_fields_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE lockup_templates_fields_map ADD CONSTRAINT FK_3BC2632751871A21 FOREIGN KEY (lockup_template_id) REFERENCES lockup_templates (id)');
        $this->addSql('ALTER TABLE lockup_templates_fields_map ADD CONSTRAINT FK_3BC26327BD6108B9 FOREIGN KEY (lockup_fields_id) REFERENCES lockup_templates_fields (id)');
    }
