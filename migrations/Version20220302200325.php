 ...
 */
final class Version20220302200325 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE lockup_templates_fields ADD uppercase INT DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE lockup_templates_fields DROP uppercase, CHANGE type type VARCHAR(30) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE name name VARCHAR(100) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE slug slug VARCHAR(100) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE placeholder placeholder VARCHAR(100) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE value value VARCHAR(100) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`');
