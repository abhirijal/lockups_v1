 ...
 */
final class Version20220304203552 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE lockup_templates_fields_map ADD CONSTRAINT FK_3BC263279C3F05EE FOREIGN KEY (lockup_template_id_id) REFERENCES lockup_templates (id)');
        $this->addSql('ALTER TABLE lockup_templates_fields_map ADD CONSTRAINT FK_3BC26327A7B1A798 FOREIGN KEY (lockups_fields_id_id) REFERENCES lockup_templates_fields (id)');
    }
