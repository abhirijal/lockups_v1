 ...
 */
final class Version20220302184806 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE lockup_templates CHANGE description description LONGTEXT DEFAULT NULL');
    }
