 ...
 */
final class Version20220302194610 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE lockup_templates_fields (id INT AUTO_INCREMENT NOT NULL, type VARCHAR(30) DEFAULT NULL, length INT DEFAULT NULL, name VARCHAR(100) DEFAULT NULL, slug VARCHAR(100) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('DROP TABLE lockup_templates_fields');
