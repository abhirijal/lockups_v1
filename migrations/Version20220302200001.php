 ...
 */
final class Version20220302200001 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE lockup_templates_fields ADD placeholder VARCHAR(100) DEFAULT NULL, ADD value VARCHAR(100) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE lockup_templates_fields DROP placeholder, DROP value, CHANGE type type VARCHAR(30) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE name name VARCHAR(100) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE slug slug VARCHAR(100) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`');
